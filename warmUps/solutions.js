...
//Write a function called bitArraySort which accepts an array of integers containing only 
//0's and 1's returns the same array back in sorted order. You can assume that all inputs will be valid. 
...
//Write a function called characterFrequencySort which accepts a string and sorts it in decreasing order 
//based on the frequency of characters and returns a new string. 
//The most frequent character should appear first with its frequency, followed by the second most frequent 
//character with its frequency, and so on. You can assume that all of the letters passed to the function 
